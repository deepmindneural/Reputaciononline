        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Gestión de comentarios</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Responde a comentarios y menciones desde una única plataforma, ahorrando tiempo y manteniendo una comunicación consistente.
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Nuestro avanzado asistente de inteligencia artificial diseñado específicamente para el monitoreo y gestión de reputación online, con capacidades predictivas y análisis semántico avanzado.
              </p>
