...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={`bg-gray-50 dark:bg-gray-800 font-medium text-gray-900 dark:text-gray-50 ${className || ''}`}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={`hover:bg-gray-50 dark:hover:bg-gray-800/50 data-[state=selected]:bg-gray-50 dark:data-[state=selected]:bg-gray-800 ${className || ''}`}
    {...props}
  />
));
