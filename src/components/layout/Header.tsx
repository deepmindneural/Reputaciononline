...
const Header: React.FC<HeaderProps> = ({ 
  isAdmin = false, 
  userName = "Juan Pérez", 
  userRole = "Candidato al Senado - Partido Nueva Esperanza",
  toggleSidebar,
  toggleDarkMode,
  isDarkMode = false
}) => {
    ...
    <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 fixed top-0 right-0 left-0 z-10 shadow-sm">
      <div className="px-4 h-18 flex justify-between items-center">
        <div className="flex items-center">
          ...
          <h1 className="text-xl font-bold text-primary-600 dark:text-primary-400 hidden md:block">Reputación Online</h1>
